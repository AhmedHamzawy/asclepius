...
<ul id="accordion" class="accordion">
    <li>
      ...
      <div class="col col_4 iamgurdeep-pic">
        ...
        <img class="img-responsive iamgurdeeposahan" alt="iamgurdeeposahan" src="{{ URL::asset('images/users/'.$patient->id.'.jpg') }}">
        <div class="edit-pic">
        ...
        <div class="username">
          ...
          <h2>{!! $patient->first_name !!}&nbsp;{!! $patient->last_name !!} <small><i class="fa fa-map-marker"></i>{!! $country[0]->name !!} 
          ({!! $patient->town !!})</small></h2>
          <p><i class="fa fa-briefcase"></i>{!! $patient->department !!}&nbsp;Patient</p>

          <a href="{{ URL::asset('admin/addmessage') }}" target="_blank" class="btn-o"> <i class="fa fa-envelope"></i> Send Message </a>
          <a href="mailto:{{ $patient->email }}" target="_blank"  class="btn-o"> <span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>
          Send Mail </a>
          ...
          <ul class="nav navbar-nav optionsnav optionsnavbar-nav">
              <li class="dropdown optionsdropdown">
                ...
                <ul class="dropdown-menu optionsdropdown-menu pull-right">
                  ...
                  <li><a href="mailto:{{ $patient->email }}">Send Mail <i class="fa fa-envelope"></i></a></li>
                </ul>
              </li>
          </ul>
    ...
    <li>
      ...
      <ul class="submenu">
        <li><a href="#"> Date of Birth : {!! $patient->birthdate !!}</a></li>
        <li><a href="#">Address : {!! $patient->address !!}</a></li>
        <li><a href="mailto:gurdeepjawaddi94@gmail.com">Email : {!! $patient->email !!}</a></li>
        <li><a href="#">Phone : {!! $patient->telephone !!}</a></li>
      </ul>
    ...
    <li>
      ...
      <ul class="submenu">
        <li class="photosgurdeep"><a href="#"><img class="img-responsive iamgurdeeposahan" alt="iamgurdeeposahan" src="{{ URL::asset('images/users/'.$patient->id.'.jpg') }}">       
      </ul>
    </li>
    ...
    <div class="modal-content col-md-12">
        ...
        <div class="modal-body">
            ...
            <div class="row" id="post-review-box" style="display:none;">
                <div class="col-md-12">
                    <form accept-charset="UTF-8" method="post"  action="{!! action('UsersController@storeReview', $patient->id) !!}">
